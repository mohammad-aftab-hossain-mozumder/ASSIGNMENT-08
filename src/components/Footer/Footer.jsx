  ...
  return (
    <div>
      <footer className="bg-black text-[#A1A1AA]">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-5 mb-15 p-9">
          <div className="md:col-span-2 col-span-1">
            <h1 className='font-bold text-xl text-white'>HERO.IO</h1>
          ...
          <div className="">
            ...
            <div className="flex items-center gap-1 my-2.5">
              <img className='size-6 border-2 border-white rounded-[5px] p-1 bg-black' src={image} alt="" />
              <p>@CS — Ticket System</p>
            </div>
        ...
        <div className="text-center text-white border-t-1 border-gray-600 py-5">
          <p className='md:text-[15px] text-[10px]'>&copy; 2025 CS — Ticket System. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
